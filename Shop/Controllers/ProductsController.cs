...
namespace Shop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductType,Price,Count")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductType,Price,Count")] Product product)
        {
            if (ModelState.IsValid)
            {
